...
public class SheetsInterface {
    ...
    private static final String SERVICE_ACCOUNT_KEY_FILE = "path/to/service_account.json"; // <-- Update this
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        String spreadsheetId = "YOUR_SPREADSHEET_ID";  // <-- Replace with your Google Sheet ID
        ...
        // ✅ 2️⃣ Write new data
        String writeRange = "Sheet1!A2"; // Start writing from A2
